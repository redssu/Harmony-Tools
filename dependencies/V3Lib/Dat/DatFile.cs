...
namespace V3Lib.Dat
{
    ...
    {
        public List<(string Name, string Type, ushort Count)> ColumnDefinitions =
            new List<(string Name, string Type, ushort Count)>();
        ...
        private static readonly Dictionary<string, int> DataTypeSizes = new Dictionary<
            string,
            int
        >()
        {
        ...
        private static readonly Dictionary<string, Func<BinaryReader, object>> ReadFunctions =
            new Dictionary<string, Func<BinaryReader, object>>()
            {
        ...
        private static readonly Dictionary<string, Action<BinaryWriter, object>> WriteFunctions =
            new Dictionary<string, Action<BinaryWriter, object>>()
            {
        ...
        public void Load(string datPath)
        {
            using BinaryReader reader = new BinaryReader(
                new FileStream(datPath, FileMode.Open, FileAccess.Read, FileShare.Read)
            );
        ...
        public void Save(string datPath)
        {
            using BinaryWriter writer = new BinaryWriter(
                new FileStream(datPath, FileMode.Create, FileAccess.Write, FileShare.None)
            );
