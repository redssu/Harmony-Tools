...
namespace V3Lib.Srd.BlockTypes
{
    ...
    public sealed class RsiBlock : Block
    {
        ...
        public byte FallbackResourceInfoCount; // resource count
        ...
        public byte[] ResourceData = new byte[] { };
        public List<string> ResourceStringList = new List<string>();
        ...
        public override void DeserializeData(byte[] rawData, string srdiPath, string srdvPath)
        {
            ...
            // Read resource info
            int resourceInfoCount =
                ResourceInfoCount != 0 ? ResourceInfoCount : FallbackResourceInfoCount;
            ...
            while (reader.BaseStream.Position < reader.BaseStream.Length)
            {
                ResourceStringList.Add(
                    Utils.ReadNullTerminatedString(reader, Encoding.GetEncoding("shift-jis"))
                );
            }
                ...
                switch (location)
                {
                    case 0x20000000: // Data is in SRDI

                        {
                            ...
                            {
                                using BinaryReader srdiReader = new BinaryReader(
                                    new FileStream(
                                        srdiPath,
                                        FileMode.Open,
                                        FileAccess.Read,
                    ...
                    case 0x40000000: // Data is in SRDV

                        {
                            ...
                            {
                                using BinaryReader srdvReader = new BinaryReader(
                                    new FileStream(
                                        srdvPath,
                                        FileMode.Open,
                                        FileAccess.Read,
                    ...
                    case 0x20000000:

                        {
                            if (srdiWriter != null)
                            {
                                ...
                                ResourceInfoList[i].Values[0] = (int)(
                                    srdiWriter.BaseStream.Position | 0x20000000
                                );
                    ...
                    case 0x40000000:

                        {
                            if (srdvWriter != null)
                            {
                                ...
                                ResourceInfoList[i].Values[0] = (int)(
                                    srdvWriter.BaseStream.Position | 0x40000000
                                );
                                ResourceInfoList[i].Values[1] = (int)(ExternalData[i].Length);
