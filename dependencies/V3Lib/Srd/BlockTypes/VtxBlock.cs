...
namespace V3Lib.Srd.BlockTypes
{
    ...
    public sealed class VtxBlock : Block
    {
        ...
        public List<short> UnknownShortList = new List<short>();
        public List<VertexDataSection> VertexDataSections = new List<VertexDataSection>();
        public short BindBoneRoot;
        public List<string> BindBoneList = new List<string>();
        public List<float> UnknownFloatList = new List<float>();
        ...
        public override void DeserializeData(byte[] rawData, string srdiPath, string srdvPath)
        {
            ...
            {
                VertexDataSections.Add(
                    new VertexDataSection(reader.ReadUInt32(), reader.ReadUInt32())
                );
            }
